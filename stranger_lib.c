/* stranger.c
 *  Author: Fang Yu   June 2007
 *  Stranger is the back end for a joint project with Marco in CS272, Spr07.
 *  Stranger uses MONA DFA package to perform string analysis.
 */
